...
public class DocumentationPluginsManager {
	...
	public Parameter expandParameter(ParameterExpansionContext context) {
		for (ExpandedParameterBuilderPlugin each : parameterExpanderPlugins
	...
	public Function<String, String> decorator(final PathContext context) {
		return new Function<String, String>() {
			...
			public String apply(String input) {
				Iterable<Function<String, String>> decorators = from(
						pathDecorators.getPluginsFor(context.documentationContext())).transform(toDecorator(context));
